...
struct Structure
{
    ...
    double                   energyElec;
    /// DFT-D3 part of the potential energy predicted. AR. Allouche
    double                   energyDFTD3;
    bool                      hasDFTD3E;// to check if E is already calculated
    bool                      hasDFTD3F;
    /// Repulsion part of the potential energy predicted. AR. Allouche
    double                   energyRep;
    bool                      hasRepE;// to check if E is already calculated
    bool                      hasRepF;
    /// External potential energy part. AR. Allouche
    double                   energyExternal;
    bool                      hasExternalE;// to check if E is already calculated
    bool                      hasExternalF;
