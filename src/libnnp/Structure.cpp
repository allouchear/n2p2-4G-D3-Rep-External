                                  ...
                                  double convCharge)
{
    ...
    // ALLOUCHE 
    double ne=5;
    energyShort    = (energyShort- numAtoms * meanEnergy/ne) * convEnergy;
    energyElec     = (energyElec- numAtoms * meanEnergy/ne) * convEnergy;
    energyDFTD3    = (energyDFTD3 - numAtoms * meanEnergy/ne) * convEnergy;
    energyRep      = (energyRep - numAtoms * meanEnergy/ne) * convEnergy;
    energyExternal = (energyExternal - numAtoms * meanEnergy/ne) * convEnergy;
    // END ALLOUCHE
                                ...
                                double convCharge)
{
    ...
    // ALLOUCHE 
    double ne=5;
    energyShort = energyShort / convEnergy + numAtoms * meanEnergy / ne;
    energyElec = energyElec / convEnergy + numAtoms * meanEnergy / ne;
    energyDFTD3 = energyDFTD3 / convEnergy + numAtoms * meanEnergy / ne;
    energyRep = energyRep / convEnergy + numAtoms * meanEnergy / ne;
    energyExternal = energyExternal / convEnergy + numAtoms * meanEnergy / ne;
    // END ALLOUCHE
