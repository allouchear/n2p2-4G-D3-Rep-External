...
contains
  ...
  subroutine gdisp(max_elem,maxc,n,xyz,iz,c6ab,mxc,r2r4,r0ab,rcov, &
    ...
    elseif ((version.eq.4).or.(version.eq.6)) then
      ...
      !$omp parallel do default(none) &
      !$omp reduction(+:dc6i, disp) &
      !$omp shared(drij, lin, abccalc, r2abc, c6abc, r3abc,  alp8, alp6) &
      !$omp private(iat, jat, kat, r2ij, linik, linjk, r2jk, r2ik, c9, rav, fdmp, mijk, imjk, ijmk, &
      !$omp& rijk3, rav3, r, dfdmp, tmp1, tmp2, dang, ang, angr9) 
      do iat=1,n
        do jat=1,iat-1
          rij=xyz(:,jat)-xyz(:,iat)
          r2=sum(rij*rij)
    ...
    if (.not.noabc)then
      ...
      !$omp shared(dc6ij, lin, abccalc, r2abc, c6abc, r3abc,  alp8, alp6) &
      !$omp private(iat, jat, kat, r2ij, linik, linjk, r2jk, r2ik, c9, rav, fdmp, mijk, imjk, ijmk, &
      !$omp& rijk3, rav3, r, dfdmp, tmp1, tmp2, dang, ang, angr9) 
      do iat=1,n
        do jat=1,iat-1
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      !$omp parallel do default(none) &
      !$omp reduction(+:disp, drij, dc6_rest_sum, dc6i) &
