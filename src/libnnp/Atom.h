...
struct Atom
{
    ...
    Vec3D                    fElec;
    /// Force vector resulting from DFT-D3 ; A.R. Allouche
    Vec3D                    fDFTD3;
    /// Force vector resulting from Rpulsive potential ; A.R. Allouche
    Vec3D                    fRep;
    /// Force vector resulting from External potential ; A.R. Allouche
    Vec3D                    fExternal;
